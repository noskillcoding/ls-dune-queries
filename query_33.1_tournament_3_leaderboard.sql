-- Tournament 3 Leaderboard (Jan 28 - Feb 4, 2026)
--
...
--
-- This leaderboard shows all participants in Tournament 3 (end time: 1770203410),
-- ranked by XP in descending order. The tournament runs Jan 28 - Feb 4, 2026.
...
WITH tournament_games AS (
  ...
  WHERE from_address = 0x02ef591697f0fd9adc0ba9dbe0ca04dabad80cf95f08ba02e435d9cb6698a28a
    ...
    AND bytearray_to_uint256(data[8]) = 1770203410  -- Tournament end time
),
