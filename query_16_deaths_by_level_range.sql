-- Deaths by Level Range (Beast Mode)
-- Shows distribution of player deaths across level ranges
-- Uses materialized view ls_2_deaths for efficiency (cheap table read, no blockchain scan)
