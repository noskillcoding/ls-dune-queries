-- Revenue & Buyback Totals (for dashboard counters)
-- Summary of all-time LORDS revenue distribution and SURVIVOR buybacks
-- LORDS USD values calculated using historical prices at time of each transaction
-- SURVIVOR USD value calculated using current price
--
-- Addresses:
